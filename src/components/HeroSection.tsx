    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto animate-fade-in-up">
          <p className="text-sm font-medium tracking-[0.2em] uppercase text-ocean-dark mb-4">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground mb-6 leading-tight text-balance">
            The easiest way to explore Dhiffushi
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-xl mx-auto">
            Trusted local excursions. Clear prices. Real people.
          </p>
